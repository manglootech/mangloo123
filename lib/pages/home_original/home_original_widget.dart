...
import 'home_original_model.dart';
...
class _HomeOriginalWidgetState extends State<HomeOriginalWidget>
    with TickerProviderStateMixin {
  late HomeOriginalModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => HomeOriginalModel());
